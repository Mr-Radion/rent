...
export function AboutApartment(): JSX.Element {
  ...
  return (
    <ul className="ul">
      ...
      <Li>
        <LiName>Name of building</LiName>
        <Input placeholder="603000" />
      </Li>
      <Li>
        <LiName>Elevator</LiName>
        <CheckboxCustom
          label="yes"
          iconWidth="16px"
          iconHeight="16px"
          labelLeft="8px"
          type="radio"
          Icon={elevator !== null ? CheckOnBasic : CheckOffBasic}
          onClickItem={elevator === null ? () => setElevator(true) : () => setElevator(null)}
        />
      </Li>
      <Li>
